...
module.exports = class extends AppGenerator {
    constructor(args, opts) {
        ...
        if (!jhContext) {
            this.error(`This is a JHipster blueprint and should be used only like ${chalk.yellow('jhipster --blueprints javaee')}`);
        }
    ...
    get initializing() {
        ...
        const javaeeInitAppPhaseSteps = {
            ...
            displayLogo() {
                ...
                this.log(chalk.white('Welcome to JHipster JavaEE') + chalk.yellow(`v${packagejs.version}`));
        ...
        return Object.assign(initPhaseFromJHipster, javaeeInitAppPhaseSteps);
    }

    get prompting() {
        this.applicationType = this.jhipsterConfig.applicationType = 'monolith';
        this.reactive = this.jhipsterConfig.reactive = 'no';
    }
